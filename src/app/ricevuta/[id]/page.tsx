...
type ReceiptData={
  ...
  order:{id:number;order_code:string;table_number:number|null;account_name:string;waiter_name:string;cashier_name:string;closed_at:string;total:number|string;guest_count:number};
